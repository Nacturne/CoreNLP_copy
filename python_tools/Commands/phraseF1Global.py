...
def eval(data_original, data_predicted, index):
    f1Score = metrics.f1_score(data_original['score'], data_predicted['score'], average='micro')
    print('{0:8}\t{1:8.5f}'.format(index,f1Score))
...
print("---------------------------------------------------------")
print("{0:8}\t{1:8}".format('length','F1 score'))
print("---------------------------------------------------------")
