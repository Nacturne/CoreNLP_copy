...
def eval(data_original, data_predicted, index):
    recall_score = metrics.recall_score(data_original['score'], data_predicted['score'], average='micro')
    print('{0:8}\t{1:8.5f}'.format(index,recall_score))
...
print("---------------------------------------------------------")
print("{0:8}\t{1:8}".format('length','Recall score'))
print("---------------------------------------------------------")
