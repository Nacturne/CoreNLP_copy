...
/** @author John Bauer */
public class Evaluate_accuracy extends AbstractEvaluate {

    final SentimentCostAndGradient cag;
    final SentimentModel model;

    public Evaluate_accuracy(SentimentModel model) {
        super(model.op);
        this.model = model;
    ...
    public static void main(String[] args) {
        ...
        Evaluate_accuracy eval = new Evaluate_accuracy(model);
        eval.eval(trees);
        
        System.out.println("global accuracy:");
        System.out.println(eval.exactNodeAccuracy());
        
        System.out.println("root accuracy:");
        System.out.println(eval.exactRootAccuracy());
    }
